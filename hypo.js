...
(function(alias) {
   ...
   */
  Hypo.princPer1 = Hypo.amortissementP1 = function amortissementP1(
    K0,
    n,
    t,
    dec
   ...
   */
  Hypo.princPer = Hypo.amortissementPn = function amortissementPn(
    K0,
    n,
    t,
    p,
   ...
   */
  Hypo.princPerP = Hypo.amortissementPnp = function amortissementPnp(
    n,
    t,
    apn1,
    p1,
  ...
  Hypo.tableauAmort = function tableauAmort(K0, n, t, p1, p2) {
    ...
    var i = p1 - 1,
      ...
      tableau = [{ K0: K0, n: n, t: t, m: mens, p1: p1, p2: p2 }];
  ...
  Hypo.tableauAmort_amd = function tableauAmort_amd(K0, n, t, n_amd, p1, p2) {
    ...
    var amd = this.VPM_amd(K0, n, t, n_amd, 2),
      ...
      mens = amd.m_amd;
    (srd = i === 0 ? K0 : this.SRDPn(mens, n, t, i)),
      (tableau = [{ K0: K0, n: n, t: t, m_amd: mens, p1: p1, p2: p2 }]);
